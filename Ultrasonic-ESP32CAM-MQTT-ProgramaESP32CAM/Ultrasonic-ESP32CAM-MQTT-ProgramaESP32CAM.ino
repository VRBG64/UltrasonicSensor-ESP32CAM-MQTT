 ...
 * por: Víctor Rogelio Barrales, retomada de la versión de Hugo Escalpelo, Profesor del IoT
 * Fecha: 10 de octubre de 2021
 * 
 * Este programa lee el sensor ultrasónico con la biblioteca Ultrasonic de Erick Simoes en su versión 3.0.0. Se mezcla con el programa ESP32CAM-MQTT-basic del repositorio de Codigo-iot. 
 * 
